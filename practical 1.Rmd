...
In this practical you get acquainted with R, RStudio and R Markdown. To make the practical, open the file "Practical 1. Working with R template.Rmd" in RStudio. This Rmd file already contains the formatted text of the practical. If you "knit" this file, it will render an html document that is identical to the original one. If you click on the "Visual" tab at the top of the file, you get a preview of what the html will look like.

All you have to do to make this practical is to fill in your name as author in the YAML, and insert R chunks with the appropriate R code and chunk options to make the exercises.

To get help on the exercises of this practical, consult the following sections of the cheat sheets:
...
```{r}
x * z
T is interpreted as 1 and F as 0
```
